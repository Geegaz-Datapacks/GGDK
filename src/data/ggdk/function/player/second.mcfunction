...
execute if score @s ggdk.alcohol >= $ggdk.consume_speed ggdk.CONST run function ggdk:player/consume_alcohol

# Don't apply effects if not drunk
execute if score @s ggdk.drunkness >= $ggdk.sober_speed ggdk.CONST run function ggdk:player/apply_drunkness
